...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://ayan-b.github.io/}{\Large Ayan Banerjee}} & \href{mailto: ayanbn7@gmail.com}{ayanbn7@gmail.com} \(|\)
 \href{https://github.com/ayan-b}{GitHub} \(|\)
 % \href{https://gitlab.com/ayan-b}{GitLab} \(|\) 
 \href{https://scholar.google.com/citations?user=HQhMWIIAAAAJ}{Google Scholar} \(|\)
 \href{https://www.linkedin.com/in/ayanb/}{LinkedIn} \(|\) \href{https://codechef.com/users/ayan_nitd}{CodeChef} \(|\) 
...
\section{Experience}
    \resumeSubHeadingListStart
        \resumeSubheading
        {The D. E. Shaw Group}{Bengaluru, India}
        {Senior Member Technical}{Nov, 2021 - Present}
        \resumeItemListStart
        \item\small{Built a different view for analysts, with custom restrictions, the ability to switch any user's view, admin view, desk view, etc. In the process, also built the base of a permission/authorization framework used throughout the code base. Used modern React like HoC, custom hooks, and compound pattern.}
        \item\small{End-to-end development of a product/feature including Requirements Gathering, Proposing Solutions, Development, Presentation to the Users, Addressing User feedback/queries}
        \item\small{\textbf{Technologies}: React, Redux, Springboot, Elastic Search, Python}
        \resumeItemListEnd
    ...
    \resumeSubHeadingListStart
        ...
        \resumeItemListStart
        \item\small{Creating data pipelines which are used by reporting services.}
        \item\small{Also worked on various PoCs including OCR, Kafka, and Deep Learning.}
        \item\small
        {\textbf{Technologies:} SAS Technologies, Python, Git, Apache Kafka, Pytorch}
        \resumeItemListEnd
    \resumeSubHeadingListEnd
    \resumeSubHeadingListStart
        \resumeSubheading
        ...
        \item\small
        {\textbf{Technologies:} C++, Cython, Git, Continuous Integration, Unit Testing (Googletest, Pytest)}
        \resumeItemListEnd
    \resumeSubHeadingListEnd
    \resumeSubHeadingListStart
        \resumeSubheading
