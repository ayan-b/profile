...
\section{Projects}
      ...
      \begin{itemize}
        ...
        \item\textbf{\href{https://github.com/ayan-b/colav}{Chat Web App}}{: A full stack web app for real time chatting using sockets, built using NodeJS, Express, ReactJS, Socket.io, MongoDB.}
...
\section{Skills}
 \resumeSubHeadingListStart
    \setlength{\itemsep}{1pt}
     ...
     \item\textbf{Familiar With}{: Linux, Go, Computer Networks, Operating System, Web Technologies (HTML, CSS, JavaScript), Backend Technologies (Django), Deep Learning, PyTorch, ReactJS, NodeJS, \LaTeX}
 \resumeSubHeadingListEnd
