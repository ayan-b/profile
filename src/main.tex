...
\section{Publications}
    ...
    \begin{itemize}
        ...
        \item{Mary J. Goldman et al}, \textit{``Visualizing and interpreting cancer genomics data via the Xena platform"}, May 22, 2020, Nature Biotechnology.
    \end{itemize}
% ------------- PROJECTS ------------------------------- %
\section{Projects}
      \setlength{\itemsep}{0.5pt}
...
\section{Skills}
 \resumeSubHeadingListStart
    \setlength{\itemsep}{1pt}
     ...
     \item\textbf{Familiar With}{: Linux, Computer Networks, Operating System, Web Technologies (HTML, CSS, JavaScript), Backend Technologies (Django), Deep Learning, PyTorch, NodeJS, Docker, \LaTeX}
 \resumeSubHeadingListEnd
