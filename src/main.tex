...
\section{Publications}
    ...
    \begin{itemize}
        \item{Aniq Ur Rahman, Sarnava Konar, \textbf{Ayan Banerjee}, \textit{``Test-bench for Task Offloading Mechanisms: Modelling the Rewards of Non-stationary Nodes"}, Published at IEEE International Conference on Advanced Networks and Telecommunications Systems (2019), Goa, India.}
    \end{itemize}
% ------------- PROJECTS ------------------------------- %
\section{Projects}
      \setlength{\itemsep}{0.5pt}
